...
const HeroSection = () => {
  ...
  const fullText = 'AI Engineer & a Data Scientist';
  ...
  const downloadResume = () => {
    ...
    link.href = '/Mohamed-Grich-Resume.pdf'; // Update with your resume file path
    link.download = 'Mohamed-Grich-Resume.pdf';
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <span className="text-foreground">I'm Mohamed, an </span>
          ...
          >
            ...
            <span className="text-secondary"> Generative AI</span>, and
            <span className="text-accent"> Agentic AI</span>.
            Building intelligent automation systems, web scraping solutions, and scalable data pipelines.
          </motion.p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {['Python', 'TensorFlow', 'PyTorch', 'FastAPI', 'Hugging Face'].map((tech) => (
            ...
            <div className="flex-shrink-0">
              <ProfilePicture 
                mainImage="/mohamed-grich.png"
                digitalImage="/mohamed-grich-ai.png"
              />
            </div>
          </div>
        </div>
