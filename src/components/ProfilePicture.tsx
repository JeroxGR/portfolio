  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        >
          <span className="px-2 py-1 text-xs bg-primary/10 text-primary rounded-full">Deep Learning</span>
          <span className="px-2 py-1 text-xs bg-secondary/10 text-secondary rounded-full">Automation</span>
          <span className="px-2 py-1 text-xs bg-accent/10 text-accent rounded-full">Web Scraping</span>
        </motion.div>
      </motion.div>
    </div>
  );
